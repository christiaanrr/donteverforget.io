"""
Django settings for donteverforget project.
...
SECRET_KEY = os.environ.get('SECRET_KEY','d66zwmn^_98gb%fe^*q4_vg(g3$c!swryy&7e%9kjp5y(ny%%*')
...
ROOT_URLCONF = 'donteverforget.urls'
...
WSGI_APPLICATION = 'donteverforget.wsgi.application'
